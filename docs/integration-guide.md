...
6. 派 Agent 到設備
   ...
   body: { "appId": "<uuid>", "apiEndpoint": "https://api.cogrow.com/api/agent/v1" }
...
| 角色 | 對應 |
|---|---|
| 我方技術窗口 | Hao（haojiecosl@gmail.com） |
| 我方 ops 通知 | 待建立（Slack / Telegram channel） |
| 你方技術窗口 | 待你方提供 |
| 你方 webhook 接收 URL | 待你方提供 |
